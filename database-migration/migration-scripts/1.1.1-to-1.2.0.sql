...
-- RSD database migration script
-- run this data migration script on the instance using
-- image ghcr.io/research-software-directory/rsd-saas/database:v1.1.1
-- to upgrade the database to strcuture of
-- image ghcr.io/research-software-directory/rsd-saas/database:v1.2.0
